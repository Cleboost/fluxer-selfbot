import type { REST } from "@fluxer-selfbot/rest";
import type { GatewayPresenceUpdateData } from "@fluxer-selfbot/types";
...
export interface ClientOptions {
	...
	/** Custom connection properties for the IDENTIFY payload (e.g. selfbots) */
